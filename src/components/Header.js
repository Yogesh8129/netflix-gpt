  ...
  return (
    <div className='flex justify-between absolute w-screen px-8 py-2 z-[1000] bg-gradient-to-b from-black'>
        ...
        <div className='flex p-2'>
          ...
          <button onClick={handleGptSearchClick} className={`py-2 px-4 mx-4 my-2 ${showGptSearch ? "bg-red-700" : "bg-purple-800"} text-white rounded-lg`}>{showGptSearch ? "Home" : "GPT Search"}</button>

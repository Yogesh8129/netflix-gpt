  ...
  return (
    <div className="absolute z-10 pt-[20%] px-24 bg-gradient-to-r from-black w-screen aspect-video">
      ...
      <div className="flex items-center space-x-2">
        <button className="bg-white text-black mx-2 p-4 px-12 text-xl rounded-lg hover:bg-opacity-5 flex items-center space-x-2">
          <svg
        ...
        <button className="bg-gray-500 text-white p-4 px-12 text-xl rounded-lg hover:bg-opacity-5 flex items-center space-x-2">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            role="img"
